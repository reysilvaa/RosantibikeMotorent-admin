              ...
              <div className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
                    ...
                    <p className="mt-1 text-lg font-semibold">{unitMotor?.platNomor}</p>
                  </div>
                  ...
                  <div className="rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
                    ...
                    <p className="mt-1">
                      <StatusBadge 
                        ...
                        variant={
                          unitMotor?.status === "TERSEDIA" ? "success" :
                          unitMotor?.status === "DISEWA" ? "info" : 
                          unitMotor?.status === "DIPESAN" ? "warning" : "danger"
                        }
                        size="medium"
                      />
                    </p>
                  ...
                  <div className="rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
                    ...
                    <p className="mt-1 text-lg">
                      {unitMotor?.jenis?.merk} {unitMotor?.jenis?.model} ({unitMotor?.jenis?.cc} CC)
                    </p>
                  </div>
                  ...
                  <div className="rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
                    ...
                    <p className="mt-1 text-lg">
                      {unitMotor?.createdAt ? formatTanggal(unitMotor.createdAt) : "-"}
                    </p>
                  </div>
                </div>
              </div>
